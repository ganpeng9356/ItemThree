...
<div id="bod">
    <div id="my1">
        <table cellspacing="0">
            ...
            <tr>
                <td class="m"><a href="#" onclick="">完善信息</a></td>
            </tr>
            <tr>
    ...
    <div id="right1">
        <div>
            ...
            <span>甘鹏，下午好！</span>欢迎您登录重庆邮电大学移通学院物资管理系统！
            <p>学号：2014220342</p>
            <p>性别：男</p>
            <p>电话：15683424649</p>
            <p>院系：无</p>
    ...
    <div id="right6">
        <table width="90%" cellspacing="0" cellpadding="0" align="center">
            ...
            <td><a href="#" onclick="returnmt('${mt3.mat_id}','${mt3.app_id}','${mt3.mat_organ}')">申请归还</a></td>
            </tr>
            </c:forEach>                
        </table>
    </div>
