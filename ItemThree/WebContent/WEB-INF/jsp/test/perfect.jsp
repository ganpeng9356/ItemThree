...
<div id="bod">
    ...
    <div id="right2">
        <div class="d1">
            <div class="d2">
             <c:forEach items="${stu}" var="stu">
                <span>姓名：${stu.stuname}</span>
                <p>学号：${stu.number}</p>
                <p>性别：${stu.stusex}</p>
                <p>电话：${stu.stutel}</p>
                </c:forEach><br>         
                <div id=formId>                     
                <form name="perfectForm" action="${pageContext.request.contextPath}/register/modifyStudent.do" method="post">
                                        院&nbsp;&nbsp;系：<input type="text" name="studepa"/><br><br>
                                        出生年月：<input type="text" name="stubirth"><br><br>
                                        邮&nbsp;&nbsp;箱：<input type="text" name="stubirt"/><br>
